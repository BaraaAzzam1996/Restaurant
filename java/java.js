...
function handle(e) {
 ...
 // let Jason = JSON.stringify(food);
  //window.localStorage.setItem("food", Jason)
...
function storeIntolocalstorage() {
  let foodArrayJson=JSON.stringify(foodArray);
  window.localStorage.setItem("food",foodArrayJson);
